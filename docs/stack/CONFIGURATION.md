...
| `scripts/test-gitlab/` | a throwaway GitLab CE for verifying Argus end to end. Not for production |

---

## 17. Scripts and entry points

All paths are relative to `stack/`.
...
[env-samples/README.md](../../stack/env-samples/README.md) has the step-by-step.
