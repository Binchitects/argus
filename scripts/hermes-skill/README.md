...
```bash
cp -r scripts/hermes-skill/argus "$HERMES_HOME/skills/"
```
...
update** — unlike the source-tree patches in `scripts/hermes-patch/`, which do
not.
...
task — see `docs/argus/roadmap.md`, milestone 2.1.
