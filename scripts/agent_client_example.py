...
This is the client half of the measurements in docs/argus/pack-measurements.md, in a
...
exists -- and a client that paraphrases them loses it.
    ...
    python scripts/agent_client_example.py http://localhost:8080/mcp <token> \\
