...
#
#   dotnet/scripts/fetch-sqlite-vec.sh            # every platform
#   dotnet/scripts/fetch-sqlite-vec.sh linux-x64  # just one
#
# Output: dotnet/native/runtimes/<rid>/native/vec0.{so,dll,dylib}, which the
