      ...
      <div className="grid gap-6">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Prometheus checks each one every 30 seconds; it fires once its condition has held for its time. They are set in <code className="text-xs">stack/config/prometheus/rules</code>.
            </CardDescription>
          </CardHeader>
          <CardContent>
            {errors.prometheus ? (
