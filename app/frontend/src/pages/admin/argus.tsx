...
function NotConfigured() {
  return (
    <EmptyState icon={Database} title="Argus is not set up in this deployment">
      Add <code className="font-mono">argus</code> to the parts that run (Settings → Deployment) and set <code className="font-mono">ARGUS_ADMIN_TOKEN</code> in <code className="font-mono">stack/.env</code>.
    </EmptyState>
  )
}
