...
EXTRACT = (
    "Below is reference documentation. Find the answer IN IT and quote the "
    "exact value. Do not rely on memory, do not paraphrase, and if the "
    "reference does not state the answer, say unknown.\n\n"
    "=== REFERENCE ===\n{ctx}\n=== END REFERENCE ===\n\n{q}")
...
async def main() -> None:
    ...
    for i, q in enumerate(questions, 1):
        ...
        replies = [ask(f.format(ctx=ctx, q=asked)) for f in FRAMINGS]
