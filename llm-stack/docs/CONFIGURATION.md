...
| `qwen3.8-flash-next.rtx5090.env` | same | RTX 5090 32 GB + 64 GB RAM | derived, not measured |
| `qwen3.8-27b.rtx3090.env` | Qwen3.8-27B, dense | RTX 3090 24 GB | measured |
| `qwen3.8-27b.rtx5090.env` | same | RTX 5090 32 GB | derived, not measured |

Adding one for another model or card is a single file: copy the closest sample,
edit its header and its MODEL block, and check it. `env-samples/README.md` has
the step-by-step.
