                  ...
                  <details className="group">
                    ...
                    <div className="mt-3 grid gap-2">
                      <p className="text-muted-foreground">
                        In <code className="font-mono">deploy/.env</code>, replace everything from <code className="font-mono"># &gt;&gt;&gt; MODEL</code> to <code className="font-mono"># &lt;&lt;&lt; MODEL</code> with this, keeping your own <code className="font-mono">LLAMACPP_MODEL_DIR</code>. Then run{' '}
